      ...
      <section className="section">
        <div className="container">
            ...
            <div className="col-md-12 col-sm-12">
              ...
              <table className="detail_table">
                <thead>
                  <tr>
                    <td>
                      <span>[{khBoardDetail?.category_name}] </span>
                      <span>{khBoardDetail?.board_title}</span>
                      <p>
                        {khBoardDetail?.user_nick} |{' '}
                        {khBoardDetail?.board_regdate}
                      </p>
                      <p className="f_right">
                        조회수 {khBoardDetail?.board_count} | 좋아요{' '}
                        {board_like}
                      </p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      ...
                      <p style={{ textAlign: 'center' }}>
                        <img
                          src={
                            khBoardDetail?.file_no == 0
                              ? main.main_bg
                              : getImgUrl(khBoardDetail?.file_no)
                          }
                          alt="img_01"
                        />
                      </p>
          ...
          <div className="text-center mt-5">
            ...
            <button
              className="btn_primary btn_cancle"
              onClick={() => navigate('/khboardlist')}
            >
              목록
            </button>
          </div>
            ...
            >
              ...
              <div className="reply_box">
                <div style={{ padding: '20px 20px' }}>
                  {comments?.map((v, i) => (
                    <KhboardComment v={v} key={i} f={getData} />
                  ))}
                </div>
